package dev.anarchy.waifuhax.api.systems.commands.arguments;
...
public class AnyArgumentType implements ArgumentType<Object> {
    ...
    public <S> CompletableFuture<Suggestions> listSuggestions(CommandContext<S> context, SuggestionsBuilder builder) {
        ...
        try {
            ...
            WHLogger.printToChat("aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
            e.printStackTrace();
        }
        ...
        if (set instanceof EnumSetting enumSetting) {
            List<String> options = List.of(Arrays.stream(enumSetting.getValue().getClass().getDeclaringClass().getEnumConstants()).map(Object::toString).toArray(String[]::new));
