...
import dev.anarchy.waifuhax.api.mixins.AbstractBlockAccessor;
...
public class TpUtils {
    ...
    public static void Move(Vec3d to, boolean setPos) {
        PlayerMoveC2SPacket.PositionAndOnGround packet = new PlayerMoveC2SPacket.PositionAndOnGround(to.x, to.y, to.z, mc.player.isOnGround(), false);
    ...
    public static void Tp(Vec3d to, Vec2f rotation, boolean setPos) {
        ...
        PlayerMoveC2SPacket.PositionAndOnGround staticPacket = new PlayerMoveC2SPacket.PositionAndOnGround(from.x, from.y, from.z, mc.player.isOnGround(), false);
        PlayerMoveC2SPacket movePacket;
        if (rotation == null) {
            movePacket = new PlayerMoveC2SPacket.PositionAndOnGround(to.x, to.y, to.z, mc.player.isOnGround(), false);
        }
        else {
            movePacket = new PlayerMoveC2SPacket.Full(to.x, to.y, to.z, rotation.y, rotation.x, mc.player.isOnGround(), false);
        }
