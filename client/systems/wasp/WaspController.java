package dev.anarchy.waifuhax.client.systems.wasp;
...
public class WaspController {
    ...
    */
    private Vec3d getPlayerSpeed() {
        ...
        double tX = instance.client.player.getX() - instance.client.player.lastX;
        double tY = instance.client.player.getY() - instance.client.player.lastY;
        double tZ = instance.client.player.getZ() - instance.client.player.lastZ;
